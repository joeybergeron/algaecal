...
gulp.task('serve', ['sass', 'js-watch', 'uglify'], function() {
  browserSync.init({
  ...
  gulp.watch("assets/css/**", ['sass']);
	gulp.watch("assets/js/**", ['js-watch', 'uglify']);
...
/* ================================= */
/* Combine JS files to a single file */
/* ================================= */
gulp.task('uglify', function() {
  gulp.src(['assets/js/bootstrap-3.3.7/bootstrap.js', 'assets/js/*.js'])
    .pipe(uglify('app.js', {
      mangle: false,
      output: {
        beautify: true
